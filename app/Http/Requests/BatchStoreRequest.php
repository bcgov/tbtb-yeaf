...
class BatchStoreRequest extends FormRequest
{
    ...
    {
        return [
            'batch_number' => 'required|between:2022010,2052010|numeric|unique:yeaf_batches,batch_number',
            'batch_date' => 'required|date|date_format:Y-m-d|unique:yeaf_batches,batch_date',
        ];
    }

...
class BatchEditRequest extends FormRequest
{
    ...
    {
        return [
            'batch_number' => 'required|digits_between:2002080,2052080|numeric|unique:batches,batch_number,'.$this->id,
            'batch_date' => 'required|date|date_format:Y-m-d|unique:batches,batch_date,'.$this->id,
        ];
    }

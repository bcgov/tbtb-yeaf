...
<body>
    ...
    <div>
        <p>I am pleased to advise that we have approved your application to the Provincial Tuition Waiver Program (PTWP) dated
            {{ date('m/d/Y', strtotime($student->application->received_date)) }}, for study terms that begin after your 19th birthday. </p>
        <p>Once you turn 19, you are eligible to have your tuition and mandatory fees waived, at an estimated total cost of
            ${{number_format($student->program->total_estimated_cost, 2, '.', ',')}}, as you work to complete your {{$student->program->credential}} at
            {{$student->program->institution_name}}. This means StudentAid BC will pay your tuition and mandatory fees for
            this program according to information submitted by {{$student->program->institution_name}}.  For questions about

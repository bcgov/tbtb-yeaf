...
<template>
    <nav class="navbar navbar-expand-lg navbar-dark shadow">
        <div class="container-fluid">
            <Link class="navbar-brand" :href="route('twp.students.index')">
            ...
            <div class="collapse navbar-collapse" id="navbarScroll">
                <ul class="navbar-nav flex-row flex-wrap ms-md-auto" style="--bs-scroll-height: 100px;">
                    <li class="nav-item">
                        <BreezeNavLink class="nav-link" :href="route('twp.students.index')" :active="route().current('students.*')">
                            Students
                        </BreezeNavLink>
                    </li>
                    <li class="nav-item">
                        <BreezeNavLink class="nav-link" :href="route('twp.application-list')" :active="route().current('application-list')">
                            Applications
                        </BreezeNavLink>
                    </li>
<!--                    <li class="nav-item">-->
<!--                        <BreezeNavLink class="nav-link" :href="route('twp.reports')" :active="route().current('reports.*')">-->
<!--                            Reports-->
<!--                        </BreezeNavLink>-->
<!--                    </li>-->
                    <li v-if="isAdmin" class="nav-item">
                        <BreezeNavLink class="nav-link" :href="route('twp.maintenance.staff.list')" :active="route().current('maintenance.*')">
                            Maintenance
                        </BreezeNavLink>
                    </li>

...
return new class extends Migration
{
    ...
    public function up()
    {
        Schema::create('payment_twps', function (Blueprint $table) {
            $table->id();
            ...
            $table->foreign('twp_program_id')->references('id')->on('program_twps')->onDelete('cascade');
    ...
    {
        Schema::dropIfExists('payment_twps');
    }
};

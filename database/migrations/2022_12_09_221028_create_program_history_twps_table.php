...
return new class extends Migration
{
    ...
    public function up()
    {
        Schema::create('program_history_twps', function (Blueprint $table) {
            $table->id();
            ...
            $table->foreign('program_twp_id')->references('id')->on('program_twps')->onDelete('cascade');
    ...
    {
        Schema::dropIfExists('program_history_twps');
    }
};
